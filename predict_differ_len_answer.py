...
parser.add_argument('--out-dir', type=str, default='/home/xllg/PycharmProjects/AttReader/data/drqa_predict',
...
examples_all = [[] for i in range(len(qes_type))] # differ qes ans
qids = [[] for i in range(len(qes_type))] # differ qes ans
    ...
    for article in data:
        for paragraph in article['paragraphs']:
            ...
            for qa in paragraph['qas']:
                ...
                if qes_start in qes_type:
                    id = qes_type.index(qes_start)
...
for num, examples in enumerate(examples_all):
    ...
    outfile = os.path.join(args.out_dir, 'qes_type_'+str(qes_type[num])+'.preds')
