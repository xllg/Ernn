...
parser.add_argument('--dataset', type=str, default='/home/xllg/PycharmProjects/ErnnReader/data/datasets/SQuAD-v1.1-dev.json',
...
parser.add_argument('--out-dir', type=str, default='/home/xllg/PycharmProjects/ErnnReader/data',
