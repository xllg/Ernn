...
def train():
  ...
  cmd.add_argument('--train_path', default='../../../data/datasets/test.txt', help='The path to the training file.')
  ...
  cmd.add_argument('--config_path', default='../configs/cnn_0_100_512_4096_sample.json', help='the path to the config file.')
  ...
  cmd.add_argument("--model", default='../../../data/outputs', help="path to save model")
